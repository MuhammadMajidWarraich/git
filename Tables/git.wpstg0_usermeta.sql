...
[user_id] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wpstg0_us__user___5D95E53A] DEFAULT ((0)),
[meta_key] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wpstg0_us__meta___5E8A0973] DEFAULT (NULL),
[meta_value] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wpstg0_us__meta___5F7E2DAC] DEFAULT (NULL)
) ON [PRIMARY]
GO
