...
[user_id] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wpstg0_us__user___703EA55A] DEFAULT ((0)),
[meta_key] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wpstg0_us__meta___7132C993] DEFAULT (NULL),
[meta_value] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wpstg0_us__meta___7226EDCC] DEFAULT (NULL)
) ON [PRIMARY]
GO
