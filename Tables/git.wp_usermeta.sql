...
[user_id] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wp_userme__user___73C51D7B] DEFAULT ((0)),
[meta_key] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wp_userme__meta___74B941B4] DEFAULT (NULL),
[meta_value] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wp_userme__meta___75AD65ED] DEFAULT (NULL)
) ON [PRIMARY]
GO
