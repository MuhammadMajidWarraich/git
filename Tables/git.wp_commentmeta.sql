...
[comment_id] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wp_commen__comme__477C86E9] DEFAULT ((0)),
[meta_key] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wp_commen__meta___4870AB22] DEFAULT (NULL),
[meta_value] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wp_commen__meta___4964CF5B] DEFAULT (NULL)
) ON [PRIMARY]
GO
