...
[term_id] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wp_term_t__term___0F624AF8] DEFAULT ((0)),
[taxonomy] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__wp_term_t__taxon__10566F31] DEFAULT (N''),
[description] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[parent] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wp_term_t__paren__114A936A] DEFAULT ((0)),
[count] [bigint] NOT NULL CONSTRAINT [DF__wp_term_t__count__123EB7A3] DEFAULT ((0))
) ON [PRIMARY]
GO
