...
[term_id] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wp_term_t__term___5D4BCC77] DEFAULT ((0)),
[taxonomy] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__wp_term_t__taxon__5E3FF0B0] DEFAULT (N''),
[description] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[parent] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wp_term_t__paren__5F3414E9] DEFAULT ((0)),
[count] [bigint] NOT NULL CONSTRAINT [DF__wp_term_t__count__60283922] DEFAULT ((0))
) ON [PRIMARY]
GO
