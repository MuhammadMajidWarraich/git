...
[post_id] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wp_postme__post___4B422AD5] DEFAULT ((0)),
[meta_key] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wp_postme__meta___4C364F0E] DEFAULT (NULL),
[meta_value] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wp_postme__meta___4D2A7347] DEFAULT (NULL)
) ON [PRIMARY]
GO
