...
[post_id] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wp_postme__post___2FEF161B] DEFAULT ((0)),
[meta_key] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wp_postme__meta___30E33A54] DEFAULT (NULL),
[meta_value] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wp_postme__meta___31D75E8D] DEFAULT (NULL)
) ON [PRIMARY]
GO
