...
GO
CREATE NONCLUSTERED INDEX [name] ON [majid].[wp_terms] ([name]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [slug] ON [majid].[wp_terms] ([slug]) ON [PRIMARY]
GO
EXEC sp_addextendedproperty N'MS_SSMA_SOURCE', N'majid.wp_terms', 'SCHEMA', N'majid', 'TABLE', N'wp_terms', NULL, NULL
GO
