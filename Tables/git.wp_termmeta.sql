...
[term_id] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wp_termme__term___0584A65A] DEFAULT ((0)),
[meta_key] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wp_termme__meta___0678CA93] DEFAULT (NULL),
[meta_value] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wp_termme__meta___076CEECC] DEFAULT (NULL)
) ON [PRIMARY]
GO
