...
[name] [nvarchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__wpstg0_ter__name__6A70BD6B] DEFAULT (N''),
[slug] [nvarchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__wpstg0_ter__slug__6B64E1A4] DEFAULT (N''),
[term_group] [bigint] NOT NULL CONSTRAINT [DF__wpstg0_te__term___6C5905DD] DEFAULT ((0))
) ON [PRIMARY]
GO
