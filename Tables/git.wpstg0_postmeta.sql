...
[post_id] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wpstg0_po__post___36670980] DEFAULT ((0)),
[meta_key] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wpstg0_po__meta___375B2DB9] DEFAULT (NULL),
[meta_value] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wpstg0_po__meta___384F51F2] DEFAULT (NULL)
) ON [PRIMARY]
GO
