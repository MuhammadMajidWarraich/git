...
[comment_id] [numeric] (20, 0) NOT NULL CONSTRAINT [DF__wpstg0_co__comme__4DF47A4E] DEFAULT ((0)),
[meta_key] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wpstg0_co__meta___4EE89E87] DEFAULT (NULL),
[meta_value] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__wpstg0_co__meta___4FDCC2C0] DEFAULT (NULL)
) ON [PRIMARY]
GO
