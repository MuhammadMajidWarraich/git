...
class Editor
{
    ...
    const  ILJ_ACTION_AFTER_ADD_TO_BLACKLIST = 'ilj_after_add_to_blacklist' ;
    const  ILJ_ACTION_AFTER_REMOVE_FROM_BLACKLIST = 'ilj_after_remove_from_blacklist' ;
    ...
    public static function saveKeywordMeta( $post_id, \WP_Post $post )
    {
        ...
        if ( array_key_exists( Postmeta::ILJ_META_KEY_LINKDEFINITION . '_keys', $_POST ) ) {
            $prev_value = get_term_meta( $post_id, Postmeta::ILJ_META_KEY_LINKDEFINITION, true );
    ...
    protected static function removeFromBlacklist( $id, $type )
    {
         ...
         * @since 1.2.23
         */
        do_action( self::ILJ_ACTION_AFTER_REMOVE_FROM_BLACKLIST, $id, $type );
    }
    ...
    protected static function addToBlacklist( $id, $type )
    {
         ...
         * @since 1.2.23
         */
        do_action( self::ILJ_ACTION_AFTER_ADD_TO_BLACKLIST, $id, $type );
    }
