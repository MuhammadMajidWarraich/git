...
define('WP_PLUGIN_URL', 'http://localhost/git/1646398157947/wp-content/plugins'); 
define('WP_LANG_DIR', __DIR__ . "/wp-content/languages"); 
define('WP_HOME', 'http://localhost/git/1646398157947'); 
define('WP_SITEURL', 'http://localhost/git/1646398157947'); 
